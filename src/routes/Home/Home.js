  ...
  return (
    <SectionWrapper ref={homeRef}>
      ...
      <TextWrapper>
        ...
        <h4>I am an AI developer</h4>
        <p>
          I am also an Azure Cloud engineer with experience working for Microsoft.
        </p>
        <p>
          I have skills as an AI and software engineer with experience gained at AGH University of Science and Technology and working sporadically as a freelance developer. 
        </p>
        <p>
